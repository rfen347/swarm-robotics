...
int main(int argc, char **argv)
{
	...
	ros::Subscriber Robot_coord_sub = n.subscribe<project1::RobotMsg>("robot_6/pos",1000, collisionCallback);

	ros::Publisher Robot_coord_pub = n.advertise<project1::RobotMsg>("robot_5/pos",1000);
